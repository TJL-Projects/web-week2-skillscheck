...
let faveColors = ['Green', 'Blue', 'Black']
...
let me = {
    firstName: 'Travis',
    superHeroName: 'Punchy',
    homeTown: 'West Philadelphia',
    superPowers: ['Gluttony', 'Mega Punch', 'Tickle Monster'],
    superPowerXP: () => Math.floor(Math.random()* 100) + 1,
    profileImage: () => `https://randomuser.me/api/portraits/med/lego/${Math.floor(Math.random() * 7) + 1 }.jpg`
}
